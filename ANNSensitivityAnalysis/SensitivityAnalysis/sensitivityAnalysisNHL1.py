...
input_names = ['OPLTYPE', 'HL_0_DIM', 'HL_0_TYPE','EPOCHS']
...
for i in range(numberOfOutputParam):
    ...
    np.savez("sobolIndices_NHL1_"+output_names[i], sobol1=sobol1, soboltotal=soboltotal);
    print("Done.");
