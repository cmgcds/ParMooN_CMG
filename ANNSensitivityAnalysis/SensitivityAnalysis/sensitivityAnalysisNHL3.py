# Sensitivity analysis of the NHL3 network
import os
...
numberOfInputParam = inputData.shape[1]-2;
...
input_names = ['OPLTYPE', 'HL_0_DIM', 'HL_0_TYPE', 'HL_1_DIM', 'HL_1_TYPE', 'HL_2_DIM', 'HL_2_TYPE','EPOCHS']
...
for i in range(numberOfOutputParam):
    ...
    np.savez("sobolIndices_NHL3_"+output_names[i], sobol1=sobol1, soboltotal=soboltotal);
    print("Done.");
