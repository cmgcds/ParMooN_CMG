...
foreach(_expectedTarget mlpack::mlpack)
...
# Create imported target mlpack::mlpack
add_library(mlpack::mlpack SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/mlpack-targets-*.cmake")
