...
//
//            break;
            // THIVIN - Change the BdID of the free surface as the surface as it has been coded in the
            // .mesh file
            // WARNING : This value is hardcoded in interior part of the code ,
            // Make it adjustable as per requirement as a variable
...
//	           GridZ[l] = OldGridZ[l] + 0.;
	        ...
	        default:
	         cout << "wrong boundary part number, Check Example file , with Bdid : " <<BdId<< endl;
	        break;
	      }// endswitch
         } //if(k
        } // endfor j
         ...
         if(Joint->GetType() == BoundaryFace)
          {
           ...
           // THIVIN - Change the BdID of the free surface as the surface as it has been coded in the
           // .mesh file
           // WARNING : This value is hard coded in interior part of the code ,
           // Make it as a Variable so that It could be easily edited.
...
//     TDatabase::ParamDB->INTERNAL_SLIP_WITH_FRICTION=1;
//   }
//   else if(CompID==4 || CompID==0 || CompID == 6)
//   {  cond = NEUMANN;}
//   
//   
// }
 ...
 switch(CompID)
  {
    ...
    case 1: 
            ...
            break;
    case 2: 
	  // Thivin - Value for the Inlet conditions.
             value=2.0 - (pow((x-0.3101),2) + pow((y-0.0978),2));
            break;
    case 3: 
            value=0;
            break;
