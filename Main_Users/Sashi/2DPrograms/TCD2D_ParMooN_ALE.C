...
// measure errors to known solution
  ...
  InitialMass = Params[0];
       OutPut("Time, C-Mass,  Diff, Relative diff, C, Vol: " <<TDatabase::TimeDB->CURRENTTIME << " " <<  Params[0] << "  " <<   Params[0]-InitialMass<< "  " << (Params[0]-InitialMass)/InitialMass << "  " << Params[2] <<"  " << Params[1] << endl);   
