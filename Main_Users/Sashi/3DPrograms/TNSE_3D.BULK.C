...
int main(int argc, char* argv[])
{
  ...
  int LEVELS, last_sq;
  int Max_It, Max_It_c, methods, mg_level, mg_type, mid_sq, low_scalar;
  int N, N_, N_Active, N_Active_c, N_Active_c_A, N_Active_c_B, N_Active_c_C;
  ...
  int N_Unknowns_c, N_Unknowns_c_A, N_Unknowns_c_B, N_Unknowns_c_C, N_Unknowns_Integral_Space;
  int N_V, Nx, Ny, Nz, Na;
  ...
  int *N_Array, *N_Array_c, *N_Array_c_A, *N_Array_c_B, *N_Array_c_C, *row_ptr;
  int *neum_to_diri, N_neum_to_diri;
  int *neum_to_diri_c_A, *neum_to_diri_c_B;
  int *neum_to_diri_c_C, *neum_to_diri_c;
  ...
  double real_time, reatt_pt, res, residual, residual_Cc;
  double solver_time, solver_time_curr;
  double t, t1, t11, t2, t22, t3, t4, t21, tau, tau1, tau2, theta1, theta2, theta3, theta4, total_time;
  double vort_zero, vort_zero_conv;
  double x, y;
  double theta11, theta21, theta31, theta41;

  // initialised double variables
  double l_infty_l_2 = 0, l_infty_l_2_time = -4711.0, l_2_h_1u = 0, l_2_l_2u = 0;
  double max_c_C = -1, nonlin_resid = 1e8, olderror_l_2_l_2u = 0, olderror_l_2_h_1u = 0;
  ...
  double *B, *B_c;
  double *coord_z_layers, *concent_C_array, *current_B, *current_sol, *current_sol_c;
  double *defect, *defect_c, *div, *dmean_velocity;
  double *frac_step_sol, *f_time_space_approx, *f_time_space_approx_old, *h1p;
  double *integral_val, *itmethod_rhs, *itmethod_sol;
  double *itmethod_rhs_c, *itmethod_sol_c, *itmethod_sol_c_A, *itmethod_sol_c_B, *itmethod_sol_c_C;
  ...
  double *neum_to_diri_c_A_x, *neum_to_diri_c_A_y, *neum_to_diri_c_A_z;
  double *neum_to_diri_c_B_x, *neum_to_diri_c_B_y, *neum_to_diri_c_B_z;
  double *neum_to_diri_c_C_x, *neum_to_diri_c_C_y, *neum_to_diri_c_C_z;
  ...
  double *oldsol, *old_sol, *oldsol_c, *oldsol_c_A, *oldsol_c_B, *oldsol_c_C;
  ...
  double *sol_c, *sol_c_A, *sol_c_B, *sol_c_C, *startsol_c;
  ...
  TFEFunction3D *Approx, *AuxPArray, *c_A, *c_B, *c_C, *Divergence;
  ...
  TFEFunction3D *integral_space_c_C_fct;
  ...
  TFEFunction3D *fefct[12], *fefct_c_C[10];
  ...
  TFEFunction3D **IntegralSpaces_c_C_fct, **PArray, **pConvArray;
  TFEFunction3D **SolArray_c_A, **SolArray_c_B, **SolArray_c_C, **SolArray_other;
  TFEFunction3D **SolArray_c_A_old, **SolArray_c_B_old, **SolArray_c_C_old;
  ...
  TFESpace3D *concentration_space, *concentration_space_b, *concentration_space_c;
  TFESpace3D *convolution_space, *integral_space_c_C;
  ...
  TFESpace3D *psd_level_space;

  TFESpace3D *ferhs[6], *fesp[4], *fesp_c_C[6];

  TFESpace3D **ConcentrationSpaces, **ConcentrationSpaces_other;
  TFESpace3D **ConcentrationSpaces_c_A, **ConcentrationSpaces_c_B, **ConcentrationSpaces_c_C;
  TFESpace3D **duConvSpaces, **IntegralSpaces_c_C;
  TFESpace3D **pConvSpaces, **ProjectionSpaces, **PsiSpaces, **PSpaces;
  TFESpace3D **uConvSpaces, **USpaces;
  FE3D *fes, *fes1;

  TItMethod *itmethod, *itmethod_c, *itmethod_c_A, *itmethod_c_B, *itmethod_c_C;
  TItMethod *prec, *prec_c_A, *prec_c_B, *prec_c_C;
  ...
  TMGLevel3D *MGLevel_c_A, *MGLevel_c_B, *MGLevel_c_C, *MGLevelGL00AuxProblem;

  TMultiGrid3D *MG_c_A, *MG_c_B, *MG_c_C, *MGGL00AuxProblem;
  ...
  TSquareMatrix3D *sqmatrixA_c_A, *sqmatrixM_c_A, *sqmatrixK_c_A;
  TSquareMatrix3D *sqmatrixA_c_B, *sqmatrixM_c_B, *sqmatrixK_c_B;
  TSquareMatrix3D *sqmatrixA_c_C, *sqmatrixM_c_C, *sqmatrixK_c_C;
  ...
  TSquareMatrix3D **MatricesA_c_A, **MatricesM_c_A, **MatricesK_c_A;
  TSquareMatrix3D **MatricesA_c_B, **MatricesM_c_B, **MatricesK_c_B;
  TSquareMatrix3D **MatricesA_c_C, **MatricesM_c_C, **MatricesK_c_C;
  TSquareMatrix3D **MatricesS_c, **MatricesS_c_A, **MatricesS_c_B, **MatricesS_c_C;

  TSquareStructure3D *matrix_structure, *sqstructureA, *sqstructureC, *sqstructure_c_A;
  TSquareStructure3D *sqstructure_c_B, *sqstructure_c_C, *sqstructureL, *sqstructurePressSep;
  ...
  a_min = TDatabase::ParamDB->BULK_D_P_0/TDatabase::ParamDB->BULK_D_P_MAX;
  average_step[0] = 0;
  ...
  SolArray_c_A = new TFEFunction3D*[LEVELS+1];
  SolArray_c_B = new TFEFunction3D*[LEVELS+1];
  SolArray_c_C = new TFEFunction3D*[LEVELS+1];
  SolArray_c_A_old = new TFEFunction3D*[LEVELS+1];
  SolArray_c_B_old = new TFEFunction3D*[LEVELS+1];
  SolArray_c_C_old = new TFEFunction3D*[LEVELS+1];
  SolArray_other = new TFEFunction3D*[LEVELS+1];
  SolArray = new TFEFunction3D*[LEVELS+1];
  SolArray_old = new TFEFunction3D*[LEVELS+1];
  SolArray_other_old = new TFEFunction3D*[LEVELS+1];
  IntegralSpaces_c_C_fct = new TFEFunction3D*[LEVELS+1];
  ...
  ConcentrationSpaces_other = new TFESpace3D*[LEVELS+1];
  ConcentrationSpaces_c_A = new TFESpace3D*[LEVELS+1];
  ConcentrationSpaces_c_B = new TFESpace3D*[LEVELS+1];
  ConcentrationSpaces_c_C = new TFESpace3D*[LEVELS+1];
  IntegralSpaces_c_C = new TFESpace3D*[LEVELS+1];

  // array which points to the system matrices on  the
  // different levels of the multigrid
  MatricesA_c = new TSquareMatrix3D*[LEVELS+1];
  MatricesA_c_A = new TSquareMatrix3D*[LEVELS+1];
  MatricesA_c_B = new TSquareMatrix3D*[LEVELS+1];
  MatricesA_c_C = new TSquareMatrix3D*[LEVELS+1];

  // array which points to the mass matrices on  the
  // different levels of the multigrid
  MatricesM_c = new TSquareMatrix3D*[LEVELS+1];
  MatricesM_c_A = new TSquareMatrix3D*[LEVELS+1];
  MatricesM_c_B = new TSquareMatrix3D*[LEVELS+1];
  MatricesM_c_C = new TSquareMatrix3D*[LEVELS+1];
  ...
  if (TDatabase::ParamDB->BULK_REACTION_DISC == SDFEM)
  {
    ...
    MatricesK_c_A = new TSquareMatrix3D*[LEVELS+1];
    MatricesK_c_B = new TSquareMatrix3D*[LEVELS+1];
    MatricesK_c_C = new TSquareMatrix3D*[LEVELS+1];
    ...
    if (TDatabase::ParamDB->SOLD_TYPE)
    {
      ...
      MatricesS_c_A = new TSquareMatrix3D*[LEVELS+1];
      MatricesS_c_B = new TSquareMatrix3D*[LEVELS+1];
      MatricesS_c_C = new TSquareMatrix3D*[LEVELS+1];
    }
  }
  ...
  DiscreteFormMatrixMBulk = new TDiscreteForm3D
  ...
  DiscreteFormMatricesA_SUPG_Bulk = new TDiscreteForm3D
    ...
    MatricesA_Assemble_SUPG_Bulk3D, BilinearCoeffs, NULL);

  DiscreteFormMatricesA_SUPG_Bulk_Cc = new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_MatricesA_SUPG_Bulk, Derivatives_MatricesA_SUPG_Bulk,
    SpacesNumbers_MatricesA_SUPG_Bulk, N_Matrices_MatricesA_SUPG_Bulk, N_Rhs_MatricesA_SUPG_Bulk,
    RowSpace_MatricesA_SUPG_Bulk, ColumnSpace_MatricesA_SUPG_Bulk, RhsSpace_MatricesA_SUPG_Bulk,
    MatricesA_Assemble_SUPG_Bulk3D, BilinearCoeffs_Cc, NULL);

  DiscreteFormRhs_SUPG_Bulk = new TDiscreteForm3D
    ...
    Rhs_Assemble_SUPG_Bulk3D, BilinearCoeffs, NULL);

  DiscreteFormRhs_SUPG_Bulk_Cc = new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_Rhs_SUPG_Bulk, Derivatives_Rhs_SUPG_Bulk,
    SpacesNumbers_Rhs_SUPG_Bulk, N_Matrices_Rhs_SUPG_Bulk, N_Rhs_Rhs_SUPG_Bulk,
    RowSpace_Rhs_SUPG_Bulk, ColumnSpace_Rhs_SUPG_Bulk, RhsSpace_Rhs_SUPG_Bulk,
    Rhs_Assemble_SUPG_Bulk3D, BilinearCoeffs_Cc, NULL);

  // discrete form for assembling stiffness matrix, upwinding
  DiscreteFormMatricesA_Bulk = new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_MatricesA_SUPG_Bulk, Derivatives_MatricesA_SUPG_Bulk,
    ...
    MatricesA_Assemble_Bulk3D, BilinearCoeffs, NULL);

  DiscreteFormMatricesA_Bulk_Cc = new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_MatricesA_SUPG_Bulk, Derivatives_MatricesA_SUPG_Bulk,
    SpacesNumbers_MatricesA_SUPG_Bulk, N_Matrices_MatricesA_Galerkin_Bulk, N_Rhs_MatricesA_SUPG_Bulk,
    RowSpace_MatricesA_Galerkin_Bulk, ColumnSpace_MatricesA_Galerkin_Bulk, RhsSpace_MatricesA_SUPG_Bulk,
    MatricesA_Assemble_Bulk3D, BilinearCoeffs_Cc, NULL);

  DiscreteFormRhs_Bulk =  new TDiscreteForm3D
    ...
    RowSpace_Rhs_SUPG_Bulk, ColumnSpace_Rhs_SUPG_Bulk, RhsSpace_Rhs_SUPG_Bulk,
    Rhs_Assemble_Bulk3D, BilinearCoeffs, NULL);

  DiscreteFormRhs_Bulk_Cc =  new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_Rhs_Galerkin_Bulk, Derivatives_Rhs_Galerkin_Bulk,
    SpacesNumbers_Rhs_Galerkin_Bulk, N_Matrices_Rhs_SUPG_Bulk, N_Rhs_Rhs_SUPG_Bulk,
    RowSpace_Rhs_SUPG_Bulk, ColumnSpace_Rhs_SUPG_Bulk, RhsSpace_Rhs_SUPG_Bulk,
    Rhs_Assemble_Bulk3D, BilinearCoeffs_Cc, NULL);

  // discrete form for assembling stiffness matrix, Galerkin (FEM-FCT)
  DiscreteFormMatricesA_Galerkin_Bulk = new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_MatricesA_SUPG_Bulk, Derivatives_MatricesA_SUPG_Bulk,
    SpacesNumbers_MatricesA_SUPG_Bulk, N_Matrices_MatricesA_Galerkin_Bulk, N_Rhs_MatricesA_SUPG_Bulk,
    RowSpace_MatricesA_Galerkin_Bulk, ColumnSpace_MatricesA_Galerkin_Bulk, RhsSpace_MatricesA_SUPG_Bulk,
    MatricesA_Assemble_Galerkin_Bulk3D, BilinearCoeffs, NULL);

  DiscreteFormMatricesA_Galerkin_Bulk_Cc = new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_MatricesA_SUPG_Bulk, Derivatives_MatricesA_SUPG_Bulk,
    SpacesNumbers_MatricesA_SUPG_Bulk, N_Matrices_MatricesA_Galerkin_Bulk, N_Rhs_MatricesA_SUPG_Bulk,
    RowSpace_MatricesA_Galerkin_Bulk, ColumnSpace_MatricesA_Galerkin_Bulk, RhsSpace_MatricesA_SUPG_Bulk,
    MatricesA_Assemble_Galerkin_Bulk3D, BilinearCoeffs_Cc, NULL);

  DiscreteFormRhs_Galerkin_Bulk =  new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_Rhs_Galerkin_Bulk, Derivatives_Rhs_Galerkin_Bulk,
    SpacesNumbers_Rhs_Galerkin_Bulk, N_Matrices_Rhs_SUPG_Bulk, N_Rhs_Rhs_SUPG_Bulk,
    RowSpace_Rhs_SUPG_Bulk, ColumnSpace_Rhs_SUPG_Bulk, RhsSpace_Rhs_SUPG_Bulk,
    Rhs_Assemble_Bulk3D, BilinearCoeffs, NULL);

  DiscreteFormRhs_Galerkin_Bulk_Cc =  new TDiscreteForm3D
    (MassMatrix, Mass, N_Terms_Rhs_Galerkin_Bulk, Derivatives_Rhs_Galerkin_Bulk,
    SpacesNumbers_Rhs_Galerkin_Bulk, N_Matrices_Rhs_SUPG_Bulk, N_Rhs_Rhs_SUPG_Bulk,
    RowSpace_Rhs_SUPG_Bulk, ColumnSpace_Rhs_SUPG_Bulk, RhsSpace_Rhs_SUPG_Bulk,
    Rhs_Assemble_Bulk3D, BilinearCoeffs_Cc, NULL);
  ...
  if(TDatabase::ParamDB->SOLVER_TYPE == GMG)
  {
    ...
    i=1;
    MG_c_A = new TMultiGrid3D(i, N_Paramters, Parameters);
    MG_c_B = new TMultiGrid3D(i, N_Paramters, Parameters);
    MG_c_C = new TMultiGrid3D(i, N_Paramters, Parameters);
  }
  ...
  for ( i=0 ; i<mg_level ; i++ )
  {
    ...
    {
      // nonconforming concentration space
      concentration_space = new TFESpace3D(coll,NameString,UString,BoundCondition_c_A,-1);
      concentration_space_b = new TFESpace3D(coll,NameString,UString,BoundCondition_c_B,-1);
      concentration_space_c = new TFESpace3D(coll,NameString,UString,BoundCondition_c_C,-1);
    }
    ...
    else
    {
      concentration_space = new TFESpace3D(coll, NameString,
        UString, BoundCondition_c_A, ansatz_order_reaction);
      concentration_space_b = new TFESpace3D(coll, NameString,
        UString, BoundCondition_c_B, ansatz_order_reaction);
      concentration_space_c = new TFESpace3D(coll, NameString,
        UString, BoundCondition_c_C, ansatz_order_reaction);
    }
    ...
    N_Active_c_B = N_Active_c_A;
    //N_Active_c_C = N_Active_c_A;
    OutPut("degrees of freedom (C_a, C_b): "<< setw(10) << N_Unknowns_c_A << " active: " <<
      N_Active_c_A << endl);
    OutPut("degrees of freedom (c_C): "<< setw(10) << N_Unknowns_c_C << " active: " <<
      N_Active_c_C << endl);
    ...
    sqstructure_c_A = new TSquareStructure3D(ConcentrationSpaces_c_A[i]);
    sqstructure_c_A->Sort();

    // two matrices used
    // A contains the non time dependent part of the discretization
    sqmatrixA = new TSquareMatrix3D(sqstructure_c_A);
    MatricesA_c_A[i] = sqmatrixA;

    // M is the mass matrix
    // the iterative solver uses M
    sqmatrixM_c_A = new TSquareMatrix3D(sqstructure_c_A);
    MatricesM_c_A[i] = sqmatrixM_c_A;

    if (TDatabase::ParamDB->BULK_REACTION_DISC == SDFEM)
    {
      // stabilisation matrix K
      sqmatrixK_c_A = new TSquareMatrix3D(sqstructure_c_A);
    ...
    c_A = new TFEFunction3D(concentration_space, c_A_String, c_A_String, sol_c_A, N_Unknowns_c_A);
    SolArray_c_A[i] = c_A;
    ...
    if(TDatabase::ParamDB->SOLVER_TYPE == GMG)
    {
      ...
      MGLevel_c_A = new TMGLevel3D(i, sqmatrixM_c_A, current_B, current_sol,  n_aux, NULL);
    ...
    // build matrices
    // first build matrix structure
    sqstructure_c_B = new TSquareStructure3D(ConcentrationSpaces_c_B[i]);
    sqstructure_c_B->Sort();

    // two matrices used
    // A contains the non time dependent part of the discretization
    sqmatrixA = new TSquareMatrix3D(sqstructure_c_B);
    MatricesA_c_B[i] = sqmatrixA;

    // M is the mass matrix
    // the iterative solver uses M
    sqmatrixM_c_B = new TSquareMatrix3D(sqstructure_c_B);
    MatricesM_c_B[i] = sqmatrixM_c_B;

    if (TDatabase::ParamDB->BULK_REACTION_DISC == SDFEM)
    {
      // stabilisation matrix K
      sqmatrixK_c_B = new TSquareMatrix3D(sqstructure_c_B);
    ...
    // allocate fe function on the current level
    c_B = new TFEFunction3D(concentration_space_b, c_B_String, c_B_String, sol_c_B, N_Unknowns_c_B);
    SolArray_c_B[i] = c_B;
    ...
    if(TDatabase::ParamDB->SOLVER_TYPE == GMG)
    {
      ...
      if ((TDatabase::ParamDB->SC_STEP_LENGTH_CONTROL_ALL_SCALAR)
        ...
        n_aux=2;
      // allocate new level and add it
      MGLevel_c_B = new TMGLevel3D(i, sqmatrixM_c_B, current_B, current_sol,  n_aux, NULL);
    ...
    // build matrices
    // first build matrix structure
    sqstructure_c_C = new TSquareStructure3D(ConcentrationSpaces_c_C[i]);
    sqstructure_c_C->Sort();

    // two matrices used
    // A contains the non time dependent part of the discretization
    sqmatrixA = new TSquareMatrix3D(sqstructure_c_C);
    MatricesA_c_C[i] = sqmatrixA;

    // M is the mass matrix
    // the iterative solver uses M
    sqmatrixM_c_C = new TSquareMatrix3D(sqstructure_c_C);
    MatricesM_c_C[i] = sqmatrixM_c_C;

    if (TDatabase::ParamDB->BULK_REACTION_DISC == SDFEM)
    {
      // stabilisation matrix K
      sqmatrixK_c_C = new TSquareMatrix3D(sqstructure_c_C);
    ...
    // allocate fe function on the current level
    c_C = new TFEFunction3D(concentration_space_c, c_C_String, c_C_String, sol_c_C, N_Unknowns_c_C);
    SolArray_c_C[i] = c_C;
    ...
    if(TDatabase::ParamDB->SOLVER_TYPE == GMG)
    {
      ...
      if ((TDatabase::ParamDB->SC_STEP_LENGTH_CONTROL_ALL_SCALAR)
        ...
        n_aux=2;
      // allocate new level and add it
      MGLevel_c_C = new TMGLevel3D(i, sqmatrixM_c_C, current_B, current_sol, n_aux, NULL);
    ...
    integral_space_c_C = new TFESpace3D(coll, NameString, UString, BoundCondition_c_C, 1);
    ...
    integral_space_c_C_fct = new TFEFunction3D(integral_space_c_C, c_A_String, c_A_String,
    ...
    if (i==mg_level-1)
    {
      ...
      {
        // space for output one level of the psd
        psd_level_space = new TFESpace3D(coll, NameString,
          UString, BoundCondition_c_C, 1);

        psd_level_fct = new double[ psd_level_space->GetN_DegreesOfFreedom()];
        memset( psd_level_fct, 0, psd_level_space->GetN_DegreesOfFreedom()* SizeOfDouble);
        psd_level_fe_fct = new TFEFunction3D(psd_level_space, PSDString, PSDString, psd_level_fct,
          psd_level_space->GetN_DegreesOfFreedom());
        // output velocity, pressure, c_A, c_B, c_C
        Output = new TOutput3D(6, 5, 1, 2, Domain);
        Output->AddFEVectFunct(u);
        Output->AddFEFunction(p);
        Output->AddFEFunction(c_A);
        Output->AddFEFunction(c_B);
        Output->AddFEFunction(c_C);
        Output->AddFEFunction(psd_level_fe_fct);
        os.seekp(std::ios::beg);
    ...
    if ((i==mg_level-1)&&(TDatabase::ParamDB->READ_GRAPE_FILE))
    {
      ...
      AuxFEFunctArray[0] = PArray[mg_level-1];
      AuxFEFunctArray[1] = c_A;
      AuxFEFunctArray[2] = c_B;
      AuxFEFunctArray[3] = c_C;
      AuxFEVectFunctArray = new TFEVectFunct3D*[1];
      AuxFEVectFunctArray[0] = UArray[mg_level-1];
      ...
      && (i==mg_level-1))
    {
      CheckWrongNeumannNodes_c_A(coll, ConcentrationSpaces_c_A[i], N_neum_to_diri_c_A, neum_to_diri_c_A,
        neum_to_diri_c_A_x, neum_to_diri_c_A_y, neum_to_diri_c_A_z);
    }
    if ((TDatabase::ParamDB->BULK_REACTION_DISC == GALERKIN) &&
      (TDatabase::ParamDB->BULK_SOLD_PARAMETER_TYPE == FEM_FCT_LIN)
      && (i==mg_level-1))
      ...
      && (i==mg_level-1))
    {
      CheckWrongNeumannNodes_c_B(coll, ConcentrationSpaces_c_B[i], N_neum_to_diri_c_B, neum_to_diri_c_B,
        neum_to_diri_c_B_x, neum_to_diri_c_B_y,  neum_to_diri_c_B_z);
    }
    if ((TDatabase::ParamDB->BULK_REACTION_DISC == GALERKIN) &&
      (TDatabase::ParamDB->BULK_SOLD_PARAMETER_TYPE == FEM_FCT_LIN)
      && (i==mg_level-1))
      ...
      && (i==mg_level-1))
    {
      CheckWrongNeumannNodes_c_C(coll, ConcentrationSpaces_c_C[i], N_neum_to_diri_c_C, neum_to_diri_c_C,
        neum_to_diri_c_C_x, neum_to_diri_c_C_y, neum_to_diri_c_C_z);
    }
    if ((TDatabase::ParamDB->BULK_REACTION_DISC == GALERKIN) &&
      (TDatabase::ParamDB->BULK_SOLD_PARAMETER_TYPE == FEM_FCT_LIN)
      && (i==mg_level-1))
    ...
    (TDatabase::ParamDB->WRITE_VTK))
  {
    ...
    if (TDatabase::ParamDB->WRITE_VTK)
    {
      ...
      //write_vtk_file(Nx, Ny, Nz, Na, cut_coord, x_coord, y_coord, z_coord, a_coord, f_time_space_approx_old,os.str().c_str());
    }
  ...
  //sol_c = new double[N_Unknowns_c_A];
  ...
  Na = TDatabase::ParamDB->N_CELL_LAYERS;
  TDatabase::ParamDB->N_CELL_LAYERS_PSD = TDatabase::ParamDB->N_CELL_LAYERS;
  ...
  if ((TDatabase::ParamDB->READ_DATA))
  {
    ...
    save_sol[2] = sol_c_B;
    save_sol[3] = sol_c_C;
    save_sol[4] = f_time_space_approx_old;
    save_N_Unknowns[0] = N_Unknowns;
    save_N_Unknowns[1] = N_Unknowns_c_A;
    save_N_Unknowns[2] = N_Unknowns_c_B;
    save_N_Unknowns[3] = N_Unknowns_c_C;
    ...
    memcpy(f_time_space_approx, f_time_space_approx_old, Nodes*SizeOfDouble);
  }
  ...
  */
  ...
  {                                               // time cycle
    ...
    for (methods=0;methods<time_discs;methods++)
    {
      ...
      t22 = GetTime();
      OutPut("time for NSE " << t22-t11 << "s" << endl);
      t21 = GetTime();
      ...
      /*real_time = TDatabase::TimeDB->CURRENTTIME / TDatabase::ParamDB->P6;
      OutPut(endl << "CURRENT TIME: ");
      OutPut(TDatabase::TimeDB->CURRENTTIME);
      OutPut(" (real time: " << real_time << " s)" << endl);
      ...
      */
      ...
      while ( !( (nonlin_resid <= limit_c) && (substance==1) ) && (nonlin_ite < Max_It_c))
      {
        switch(substance)
        {
          ...
          case 0:
            ...
            neum_to_diri_x = neum_to_diri_c_B_x;
            neum_to_diri_y = neum_to_diri_c_B_y;
            neum_to_diri_z = neum_to_diri_c_B_z;
          ...
          case 1:
            ...
            neum_to_diri_x = neum_to_diri_c_A_x;
            neum_to_diri_y = neum_to_diri_c_A_y;
            neum_to_diri_z = neum_to_diri_c_A_z;
            ...
            for (j=0;j<8;j++)
            {
              ...
              if( fabs(cell->GetVertex(j)->GetX() - 1) < 1e-6)
              {
            SolArray_c_A[mg_level-1]->FindGradient(cell->GetVertex(j)->GetX(),
                     cell->GetVertex(j)->GetY(),
                     cell->GetVertex(j)->GetZ(),
            errors);
            if (fabs(errors[0]) > 1e-3)
            {
            OutPut("wrong " << cell->GetVertex(j)->GetX()<< " " <<
            cell->GetVertex(j)->GetY() << " " <<
            cell->GetVertex(j)->GetZ()<< " " <<
            errors[0] << endl);
            }
        ...
        if (nonlin_ite-substance==0)
        {
          ...
          fefct[3] = U3Array[mg_level-1];

          aux =  new TAuxParam3D(TimeCDParamsBulkN_FESpaces,
        ...
        else
        {
          ...
          theta11 = TDatabase::TimeDB->THETA1;
          theta21 = TDatabase::TimeDB->THETA2;
          theta31 = TDatabase::TimeDB->THETA3;
          theta41 = TDatabase::TimeDB->THETA4;
          ...
          TDatabase::TimeDB->THETA1 = theta11;
          TDatabase::TimeDB->THETA2 = theta21;
          TDatabase::TimeDB->THETA3 = theta31;
          TDatabase::TimeDB->THETA4 = theta41;
        ...
        if (fabs(errors[0]) > 1e-3)
        {
        OutPut("after wrong " << cell->GetVertex(j)->GetX()<< " " <<
        cell->GetVertex(j)->GetY() << " " <<
        cell->GetVertex(j)->GetZ()<< " " <<
        errors[0] << endl);
        }
      ...
      neum_to_diri_x = neum_to_diri_c_C_x;
      neum_to_diri_y = neum_to_diri_c_C_y;
      neum_to_diri_z = neum_to_diri_c_C_z;
      ...
      fefct_c_C[4] = U3Array[mg_level-1];
      fefct_c_C[5] = SolArray_c_C[mg_level-1];
      fefct_c_C[6] = IntegralSpaces_c_C_fct[mg_level-1];

      aux =  new TAuxParam3D(TimeCDParamsBulk_CcN_FESpaces,
      ...
      Assemble3D(N_FESpaces, fesp_c_C,
        0, NULL,
        0, NULL,
        N_Rhs, RHSs, ferhs,
        DiscreteForm,
      ...
      for(i=low_scalar;i<mg_level;i++)
      {
        ...
        fesp_c_C[5] = IntegralSpaces_c_C[i];

        fefct_c_C[0] = SolArray_c_A[i];
        fefct_c_C[1] = SolArray_c_B[i];
        fefct_c_C[2] = U1Array[i];
        fefct_c_C[3] = U2Array[i];
        fefct_c_C[4] = U3Array[i];
        fefct_c_C[5] = SolArray_c_C[i];
        fefct_c_C[6] = IntegralSpaces_c_C_fct[i];
        ...
        {
          OutPut("SOLD not yet implemented " << endl);
          exit(4711);
          /*fefct_c_C[7] = SolArray_c_C_old[i];
          fefct_c_C[8] = SolArray_c_A_old[i];
          fefct_c_C[9] = SolArray_c_B_old[i];
      ...
      t22 = GetTime();
      OutPut("time for concentration " << t22-t21 << "s" << endl);
      ...
      {
        //first time step
        if (( m==1 )&&(!TDatabase::ParamDB->READ_DATA))
        {
        ...
        else
        {
          ...
          Bulk_FWE_FDM_Upwind_4D(coll, u1, u2, u3, c_C, f_time_space_approx_old,
            Nx, Ny, Nz, Na,
            x_coord, y_coord, z_coord, a_coord,
            x_min, x_max, y_min, y_max, z_min, z_max, a_min, a_max,
            velo1, velo2, velo3, concent_C_array, correspond_3dgrid);
      ...
      if (TDatabase::ParamDB->BULK_PB_DISC== BULK_BWE_FDM_UPWIND)
      {
        ...
        Bulk_BWE_FDM_Upwind_4D(coll, u1, u2, u3, c_C, f_time_space_approx_old,
      ...
      if (TDatabase::ParamDB->BULK_PB_DISC== BULK_BWE_FEM_SUPG)
      {
        OutPut("===== Begin Backward Euler FEM - SUPG Method ======="<< endl);

        Build_4D_FEM_Matrix_Q1(coll, u1, u2, u3, c_C, f_time_space_approx_old,
          f_time_space_approx_old,
          lump_mass_PSD, matrix_D_Entries_PSD,
          correspond_3dgrid, Nx, Ny, Nz, Na,
          x_coord, y_coord, z_coord, a_coord, mat, matM);

        OutPut("===== Begin Backward Euler FEM - SUPG Method ======="<< endl);
      }

      // save the actual array of f_time_space_approx_old for later computations
      // save_f_old_in_txt_file( Nodes, f_time_space_approx_old, file_name_f_old);
      ...
      if (TDatabase::ParamDB->BULK_PB_DISC== BULK_FEM_FCT)
      {
        ...
        if (first_psd_fem)
        {
          ...
          Compute_Neum_To_Diri_FEM_FCT(Nx, Ny, Nz, Na,
            x_coord, y_coord, z_coord, a_coord,
            N_neum_to_diri_psd,
            neum_to_diri_psd,
            neum_to_diri_psd_x,
        ...
        Build_4D_FEM_FCT_Matrix_Q1(coll, u1, u2, u3, c_C, f_time_space_approx, f_time_space_approx_old,
          lump_mass_PSD, matrix_D_Entries_PSD,
          correspond_3dgrid, Nx, Ny, Nz, Na,
      ...
      Evaluate_f_at_outflow(Nx, Ny, Nz, Na, x_coord, y_coord,
        a_layers_coord, f_time_space_approx_old,
      ...
      Integral_For_Particle_Increase_Term(integral_space_c_C, integral_space_c_C_fct,
        ...
        concent_C_array, f_time_space_approx_old);

      t22 = GetTime();
      OutPut("time for PSD " << t22-t21 << "s" << endl);
      ...
      || (TDatabase::ParamDB->SAVE_DATA))
    {
      if(m % TDatabase::TimeDB->STEPS_PER_IMAGE == 0)
      {
        ...
        {
          os.seekp(std::ios::beg);
          os << GmvBaseName << m + 92600 << ".gmv" << ends;
          Output->WriteGMV(os.str().c_str());
        }
        ...
        {
          os.seekp(std::ios::beg);
          //os << VtkBaseName << m + 92600 << ".vtk" << ends;
  ...
  if ((TDatabase::ParamDB->WRITE_GRAPE)||(TDatabase::ParamDB->WRITE_GMV)||(TDatabase::ParamDB->WRITE_VTK))
  {
    // compute one level of psd
    Compute_psd_level(coll, psd_level_space, psd_level_fe_fct,
      Nx, Ny, Nz, Na, x_coord, y_coord,
      z_coord, a_layers_coord, f_time_space_approx_old);
