...
void Exact(double x, double y, double *values)
{
  ...
  values[0] = sin(t)*(sin(2*Pi*x)*sin(2*Pi*y));
        ...
        double **parameters, double **coeffs)
{
  ...
  for(i=0;i<n_points;i++)
  {
    ...
    coeff[4] = cos(t)*(sin(2*Pi*x)*sin(2*Pi*y))
	- eps * sin(t)*4*Pi*Pi*(-sin(2*Pi*x)*sin(2*Pi*y)-sin(2*Pi*x)*sin(2*Pi*y))
       + a * sin(t)*2*Pi*cos(2*Pi*x)*sin(2*Pi*y)
       + b * sin(t)*2*Pi*sin(2*Pi*x)*cos(2*Pi*y)
	+ c *  sin(t)*(sin(2*Pi*x)*sin(2*Pi*y));
  }
}
