   ...
   for(i=0;i<N_Vertices; i++)
    {
     ...
     if(TDatabase::ParamDB->P13==0)
      ...
      {
       //Front side 
       //center point is  side  300.565, 69.66666666666666, 157.038  
       DispX = 0.;
       DispY = 69.66666666666666;
       DispZ = 0.;       
      }  
//        if( sqrt((X -2.922130000000000e+02)*(X -291.977) + (Y+1.8733333333333333)*(Y+-1.8733333333333333) + (Z-1.583800000000000e+02)*(Z-1.583800000000000e+02)  ) < 1.e-5)
//           cout<< i << " vert X: " <<X << " vert Y: " <<Y <<" vert Z: " <<Z <<endl;      
//   98 vert X: 292.213 vert Y: -1.87333 vert Z: 158.38
