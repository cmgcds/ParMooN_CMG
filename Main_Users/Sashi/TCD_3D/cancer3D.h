...
void V_BoundCondition(double x, double y, double z, BoundCond &cond)
{
  cond = DIRICHLET;
}


void W_BoundCondition(double x, double y, double z, BoundCond &cond)
{
  cond = DIRICHLET;
}
...
void V_BoundValue(double x, double y, double z, double &value)
{
 double t = TDatabase::TimeDB->CURRENTTIME;
 double k = 0.1;
...
void W_BoundValue(double x, double y, double z, double &value)
{
 double t = TDatabase::TimeDB->CURRENTTIME;
 double k = 0.1;
...
void V_BilinearCoeffs(int n_points, double *X, double *Y, double *Z,
               double **parameters, double **coeffs)
{
//   double eps= 1.0/TDatabase::ParamDB->RE_NR;
  double eps= 1.0;
...
void W_BilinearCoeffs(int n_points, double *X, double *Y, double *Z,
               double **parameters, double **coeffs)
{
//   double eps= 1.0/TDatabase::ParamDB->RE_NR;
  double eps= 1.0;
