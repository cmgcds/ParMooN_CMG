...
void ExampleFile()
{
  OutPut("Example: ChannelStep_Bosch.h" << endl) ;
}
// ========================================================================
// initial solution
// ========================================================================
                          ...
                          double &reattachment_point)
{
  ...
  for(i=0;i<N_Cells;i++)
  {
    ...
    FE_Obj = TFEDatabase::GetFE2D(FE_ID);
    ...
    TFEDatabase::SetCellForRefTrans(cell, RefTrans);
    for (j=0;j<N_Edges;j++)
      xv[j] = 0;
    for (j=0;j<N_Edges;j++)
    {
     ...
     // point not on boundary
      ...
      TFEDatabase::GetRefFromOrig(RefTrans, x, y, xi, eta);
      //cout << " xi: " << xi << endl;
      //cout << "eta: " << eta << endl;
      ...
      TFEDatabase::GetOrigValues(RefTrans, xi, eta, N_BaseFunct,
