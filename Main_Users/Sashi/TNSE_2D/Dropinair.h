...
void BoundCondition(int i, double t, BoundCond &cond)
{
 ...
 /*
  switch(i)
      {
        case 1:
             cond = SLIP_FRICTION_PENETRATION_RESISTANCE; //DIRICHLET; //
        break;
...
//   opts<<'Y'; // Supress adding vertices on boundary edges
  ...
  N_Interf_Vertices = N_FreeBound_Vert;
  ...
  CurrComp = 1;
   ...
   theta = 0.; // end degree value of freesurface
   dt = 2.*Pi/N_FreeBound_Vert;
