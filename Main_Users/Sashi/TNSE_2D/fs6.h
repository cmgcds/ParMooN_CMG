...
void InitialP(double x, double y, double *values)
{
  ...
  values[0] = t*t*t*x+y-0.5*(1+t*t*t);
}
...
void U2BoundValue(int BdComp, double Param, double &value)
{
  ...
  {
    case 0:
      value = t*2*Param*Param;
    break;
    case 1:
      value = t*2;
    break;
    case 2:
      value = t*2*(1-Param)*(1-Param);
    break;
    case 3:
      value = 0;
    break;
               ...
               double **parameters, double **coeffs)
{
  ...
  for(i=0;i<n_points;i++)
  {
    ...
    coeff[1] = y*y -2*nu*t + 4*x*x*y*t*t + t*t*t;
    coeff[2] = 2*x*x -4*nu*t + 4*y*y*x*t*t + 1;
    coeff[3] = 3*t*t;
    coeff[4] = 0;
