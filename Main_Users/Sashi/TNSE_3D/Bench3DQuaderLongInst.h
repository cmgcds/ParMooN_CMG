...
void ExampleFile()
{
  OutPut("Example: Bench3DQuaderLongInst.h" << endl) ;
}
// ========================================================================
// initial condition
// ========================================================================
...
void U1BoundValue(double x, double y, double z, double &value)
{
  ...
  if( (fabs(x)<1e-6) || (fabs(x-2.65)<1e-6) )
  {
      if (t<4)
	  value = 16*2.25*y*(0.41-y)*z*(0.41-z)*sin(Pi*t/8.0)/(0.41*0.41*0.41*0.41);
      else
	  value = 16*2.25*y*(0.41-y)*z*(0.41-z)/(0.41*0.41*0.41*0.41);
  }
  else
  {
    value = 0;
...
void U1BoundValue_diff(double x, double y, double z, double &value)
{
  ...
  {
      if (t<4)
	  value = (Pi/8)*16*2.25*y*(0.41-y)*z*(0.41-z)*cos(Pi*t/8.0)/(0.41*0.41*0.41*0.41);
      else
	  value = 0;
  }
  else
