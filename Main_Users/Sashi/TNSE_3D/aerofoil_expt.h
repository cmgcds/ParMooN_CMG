...
void ExampleFile()
{
  OutPut("Example: Aerofoil_expt.h" << endl);
}

void GridBoundCondition(int i, double x, double y, double z, BoundCond &cond)
{
  cond = DIRICHLET;
}
// exact solution
...
// //      dat >> x  >> y  >> z ;
// //      In.pointlist[3*i] = -x/100.;
// //      In.pointlist[3*i+1] =y/100.;
// //      In.pointlist[3*i+2] = z/100.;
//      
...
//     opts<<'V';  //verbose mode
//     opts<<ends;
//        cout<< "test  DeleteDomain " <<endl;
//   
// //   cout << " SMESHFILE is " << SMESH << endl;
//   /** load the medit mesh file into Tetgen */  
//   ReadMeditMesh(SMESH, In);
//   
//          cout<< "test  DeleteDomain 2" <<endl;
// //     for(i=0;i<In.numberofpoints;i++)
// //       OutPut(i<<" (x, y, z) =  "<<
// //        In.pointlist[3*i]<<' '<<In.pointlist[3*i+1]<<' '<<In.pointlist[3*i+2]<<endl);
// 
