...
#endif
  { 
   OutPut("Example: masud_ijnmf.h " << endl);
  }
 ...
 switch(BdComp)
  {
    ...
    case 2: case 4: case 3:case 5: case 6:case 7:
      cond = DIRICHLET;
       break;
		      ...
		      TBaseCell ** MovCells, double t)
{
 ...
 TVertex* vert;
  ...
  if(TDatabase::TimeDB->CURRENTTIME <= 6.395)
  {
    disp=(0.05/6.395)*t;  
  }
  else
  {
    disp= 0.05*sin(3.93*(t-6.395))+0.05;    
  }
...
void U2BoundValue(int CompID, double x, double y, double z, double &value)
{
 ...
 switch(CompID)
 {
   ...
   case 6:
      ...
      {
	   value=0.05*3.93*cos(3.93*(t-6.395));
