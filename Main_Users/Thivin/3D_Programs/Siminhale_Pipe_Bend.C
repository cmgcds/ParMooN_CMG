...
int main(int argc, char *argv[])
{
	...
	TParticles* particleObject =  new TParticles(numPart,0.0,0.0,0.01*0.5,Velocity_FeSpace[0], resumeFile, &StartNo);
