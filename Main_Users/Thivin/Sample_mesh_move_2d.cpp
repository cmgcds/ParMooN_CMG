...
void BoundValue_X(int BdComp, double Param, double &value)
{
  switch(BdComp)
  {
    ...
    case 2:
      ...
      break;
    case 1:
      value = 0.5; // boundval *Param;
      break;
    case 3:
      value = 0; // boundval * (1 - Param);
      break;
    }
}
...
int N_Cells, ORDER, N_U, N_P, N_DOF, N_Active;
  ...
  // refine grid up to the Finest  level
    ...
    deformMesh2D* mesh_deform = new deformMesh2D(coll, BoundCondition_X, BoundCondition_Y, BoundValue_X,  BoundValue_Y);
