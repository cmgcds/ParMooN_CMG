...
// ========================================================================
// parameters: u1old, u2old, u3old , w1, w2, w3
// ========================================================================

void TimeNSParamsVelo3D_ALE(double *in, double *out);
  int TimeNSN_FESpacesVelo_ALE = 2;
  int TimeNSN_FctVelo_ALE = 6;
  int TimeNSN_ParamFctVelo_ALE = 1;
  int TimeNSN_FEValuesVelo_ALE = 6;
  int TimeNSN_ParamsVelo_ALE = 6;
  int TimeNSFEFctIndexVelo_ALE[6] = { 0, 1, 2,3,4,5 };
  MultiIndex3D TimeNSFEMultiIndexVelo_ALE[6] = { D000, D000, D000,D000, D000, D000 };
  ParamFct *TimeNSFctVelo_ALE[1] = { TimeNSParamsVelo3D_ALE };
  int TimeNSBeginParamVelo_ALE[1] = { 0 };
