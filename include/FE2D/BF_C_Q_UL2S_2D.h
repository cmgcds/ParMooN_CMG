...
static void C_Q_UL2S_2D_DeriveXiXi(double xi, double eta, double *values)
{
  double t1, t2, t3, t4;
...
static void C_Q_UL2S_2D_DeriveEtaEta(double xi, double eta, double *values)
{
  double t1, t2, t3, t4;
...
TBaseFunct2D *BF_C_Q_UL2S_2D_Obj = new TBaseFunct2D
        (9, BF_C_Q_UL2S_2D, BFUnitSquare, 
         C_Q_UL2S_2D_Funct, C_Q_UL2S_2D_DeriveXi,
         C_Q_UL2S_2D_DeriveEta, C_Q_UL2S_2D_DeriveXiXi,
         C_Q_UL2S_2D_DeriveXiEta, C_Q_UL2S_2D_DeriveEtaEta, 2, 2,
         0, NULL);
