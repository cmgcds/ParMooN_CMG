...
void NF_C_Q_M8_2D_EvalAll(TCollection *Coll, TBaseCell *Cell, double *PointValues,
                          double *Functionals)
{
  memcpy(Functionals, PointValues, 47*SizeOfDouble);
};

void NF_C_Q_M8_2D_EvalEdge(TCollection *Coll, TBaseCell *Cell, int Joint, double *PointValues,
                           double *Functionals)
{
  memcpy(Functionals, PointValues, 9*SizeOfDouble);
};

TNodalFunctional2D *NF_C_Q_M8_2D_Obj = new TNodalFunctional2D
        (NF_C_Q_M8_2D, 47, 9, 47, 9, NF_C_Q_M8_2D_Xi, NF_C_Q_M8_2D_Eta,
         NF_C_Q_M8_2D_T, NF_C_Q_M8_2D_EvalAll, NF_C_Q_M8_2D_EvalEdge);
