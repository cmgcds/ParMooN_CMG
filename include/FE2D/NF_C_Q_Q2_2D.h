...
void NF_C_Q_Q2_2D_EvalAll(TCollection *Coll, TBaseCell *Cell, double *PointValues,
                          double *Functionals)
{
...
void NF_C_Q_Q2_2D_EvalEdge(TCollection *Coll, TBaseCell *Cell, int Joint, double *PointValues,
                           double *Functionals)
{
  Functionals[0] = PointValues[0];
  Functionals[1] = PointValues[1];
...
TNodalFunctional2D *NF_C_Q_Q2_2D_Obj = new TNodalFunctional2D
        (NF_C_Q_Q2_2D, 9, 3, 9, 3, NF_C_Q_Q2_2D_Xi, NF_C_Q_Q2_2D_Eta,
         NF_C_Q_Q2_2D_T, NF_C_Q_Q2_2D_EvalAll, NF_C_Q_Q2_2D_EvalEdge);
