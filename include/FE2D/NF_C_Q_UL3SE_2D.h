...
TNodalFunctional2D *NF_C_Q_UL3SE_2D_Obj = new TNodalFunctional2D
        (NF_C_Q_UL3SE_2D, 13, 4, 13, 4, NF_C_Q_UL3SE_2D_Xi, NF_C_Q_UL3SE_2D_Eta,
         NF_C_Q_UL3SE_2D_T, NF_C_Q_UL3SE_2D_EvalAll, NF_C_Q_UL3SE_2D_EvalEdge);
