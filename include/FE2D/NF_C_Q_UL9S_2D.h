...
void NF_C_Q_UL9S_2D_EvalAll(TCollection *Coll, TBaseCell *Cell, double *PointValues,
                          double *Functionals)
{
  memcpy(Functionals, PointValues, 87*SizeOfDouble);
};

void NF_C_Q_UL9S_2D_EvalEdge(TCollection *Coll, TBaseCell *Cell, int Joint, double *PointValues,
                           double *Functionals)
{
  memcpy(Functionals, PointValues, 10*SizeOfDouble);
};

TNodalFunctional2D *NF_C_Q_UL9S_2D_Obj = new TNodalFunctional2D
        (NF_C_Q_UL9S_2D, 87, 10, 87, 10, NF_C_Q_UL9S_2D_Xi, NF_C_Q_UL9S_2D_Eta,
         NF_C_Q_UL9S_2D_T, NF_C_Q_UL9S_2D_EvalAll, NF_C_Q_UL9S_2D_EvalEdge);
