...
void NF_N_Q_Q2_2D_EvalAll(TCollection *Coll, TBaseCell *Cell, double *PointValues,
                          double *Functionals)
{
  int OwnNum, NeighNum;
  TBaseCell *neigh;
...
void NF_N_Q_Q2_2D_EvalEdge(TCollection *Coll, TBaseCell *Cell, int Joint,
...
TNodalFunctional2D *NF_N_Q_Q2_2D_Obj = new TNodalFunctional2D
        (NF_N_Q_Q2_2D, 9, 2, 21, 3, NF_N_Q_Q2_2D_Xi, NF_N_Q_Q2_2D_Eta,
         NF_N_Q_Q2_2D_T, NF_N_Q_Q2_2D_EvalAll, NF_N_Q_Q2_2D_EvalEdge);
