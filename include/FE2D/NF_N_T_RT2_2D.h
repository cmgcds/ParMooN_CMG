...
static double NF_N_T_RT2_2D_Xi[] =  {0};
static double NF_N_T_RT2_2D_Eta[] = {0};
...
//static double NF_N_T_RT2_2D_T[] = {-0.866025403784439,0,0.866025403784439};//Tschebyscheff-points
...
TNodalFunctional2D *NF_N_T_RT2_2D_Obj = new TNodalFunctional2D
        (NF_N_T_RT2_2D, 15, 3, 1, 3, NF_N_T_RT2_2D_Xi, NF_N_T_RT2_2D_Eta,
