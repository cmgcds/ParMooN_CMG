/****************************************************************************/
/*                                                                          */
/* File:          amg_blas_nse2d.c                                          */
/*                                                                          */
/* Purpose:   matrix vector operations for 2d Navier-Stokes problems        */
/*                                                                          */
...
int AMG_dmatmul_SADDLE_2_TYPE_1 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_1 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_1 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b0)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_1 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if (2*n_a!=n_b0+n_b1)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_1 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
...
int AMG_dmatminus_SADDLE_2_TYPE_1 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_1 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_1 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b0)
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_1 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if (2*n_a!=n_b0+n_b1)
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_1 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
...
int AMG_A_dmatmul_SADDLE_2_TYPE_1 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatmul SADDLE_2_TYPE_1 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatmul SADDLE_2_TYPE_1 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
...
int AMG_A_dmatminus_SADDLE_2_TYPE_1 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatminus SADDLE_2_TYPE_1 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatminus SADDLE_2_TYPE_1 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
...
int AMG_B_dmatmul_SADDLE_2_TYPE_1 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: B_dmatmul SADDLE_2_TYPE_1 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=n_b0+n_b1)
     {
        AMG_Print("ERROR: B_dmatmul SADDLE_2_TYPE_1 - vector and matrix lengths mismatched(1) !!\n");
        exit(4711);
     }
     if (n_y!=m_b0)
     {
        AMG_Print("ERROR: B_dmatmul SADDLE_2_TYPE_1 - vector and matrix lengths mismatched(2) !!\n");
        exit(4711);
     }
  }
  x = AMG_VECTOR_X(x_);
...
int AMG_B_Trans_dmatmul_SADDLE_2_TYPE_1 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     ...
     if (n_y!=n_b0+n_b1)
     {
        AMG_Print("ERROR: B_Trans_dmatmul SADDLE_2_TYPE_1 - vector and matrix lengths mismatched(1) !!\n");
        exit(4711);
     }
     if (n_x!=m_b0)
     {
        AMG_Print("ERROR: B_Trans_dmatmul SADDLE_2_TYPE_1 - vector and matrix lengths mismatched(2) !!\n");
        exit(4711);
     }
  }
  x = AMG_VECTOR_X(x_);
...
int AMG_dmatmul_SADDLE_2_TYPE_2 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_2 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if ((m_b2!=m_b3)||(n_b2!=n_b3)|| (m_b0!=m_b1)||(n_b0!=n_b1)) 
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_2 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b2)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_2 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if ((2*n_a!=m_b0+m_b1)||(2*n_a!=n_b2+n_b3))
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_2 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
...
int AMG_dmatminus_SADDLE_2_TYPE_2 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_2 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if ((m_b2!=m_b3)||(n_b2!=n_b3)|| (m_b0!=m_b1)||(n_b0!=n_b1)) 
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_2 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b2)
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_2 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if ((2*n_a!=m_b0+m_b1)||(2*n_a!=n_b2+n_b3))
     {
        AMG_Print("ERROR: dmatminus SADDLE_2_TYPE_2 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
...
int AMG_B_dmatmul_SADDLE_2_TYPE_2 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_b0!=n_b1)
     {
        AMG_Print("ERROR: B_dmatmul SADDLE_2_TYPE_2 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=m_b0+m_b1)
     {
        AMG_Print("ERROR: B_dmatmul SADDLE_2_TYPE_2 - vector and matrix lengths mismatched(1) !!\n");
        exit(4711);
     }
     if (n_y!=n_b0)
     {
        AMG_Print("ERROR: B_dmatmul SADDLE_2_TYPE_2 - vector and matrix lengths mismatched(2) !!\n");
        exit(4711);
     }
  }
  x = AMG_VECTOR_X(x_);
...
int AMG_B_Trans_dmatmul_SADDLE_2_TYPE_2 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: B_Trans_dmatmul SADDLE_2_TYPE_2 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_y!=n_b0+n_b1)
     {
        AMG_Print("ERROR: B_Trans_dmatmul SADDLE_2_TYPE_2 - vector and matrix lengths mismatched(1) !!\n");
        exit(4711);
     }
     if (n_x!=m_b0)
     {
        AMG_Print("ERROR: B_Trans_dmatmul SADDLE_2_TYPE_2 - vector and matrix lengths mismatched(2) !!\n");
        exit(4711);
     }
  }
  x = AMG_VECTOR_X(x_);
...
int AMG_dmatmul_SADDLE_2_TYPE_3 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_3 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_3 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b0)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_3 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if (2*n_a!=n_b0+n_b1)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_3 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
                                   ...
                                   AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatmul SADDLE_2_TYPE_3 - vector lengths mismatched !!\n");
        exit(4711);
     }
     
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatmul SADDLE_2_TYPE_3 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
                                     ...
                                     AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatminus SADDLE_2_TYPE_3 - vector lengths mismatched !!\n");
        exit(4711);
     }
     
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatminus SADDLE_2_TYPE_3 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
...
int AMG_dmatmul_SADDLE_2_TYPE_4 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_4 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if ((m_b2!=m_b3)||(n_b2!=n_b3)|| (m_b0!=m_b1)||(n_b0!=n_b1)) 
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_4 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b2)
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_4 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if ((2*n_a!=m_b0+m_b1)||(2*n_a!=n_b2+n_b3))
     {
        AMG_Print("ERROR: dmatmul SADDLE_2_TYPE_4 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
                                   ...
                                   AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatmul SADDLE_2_TYPE_4 - vector lengths mismatched !!\n");
        exit(4711);
     }
     
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatmul SADDLE_2_TYPE_4 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
                                   ...
                                   AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatminus SADDLE_2_TYPE_4 - vector lengths mismatched !!\n");
        exit(4711);
     }
     
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatminus SADDLE_2_TYPE_4 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
                                                ...
                                                AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_1 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_1 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b0)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_1 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if (2*n_a!=n_b0+n_b1)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_1 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
                                                ...
                                                AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_2 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if ((m_b2!=m_b3)||(n_b2!=n_b3)|| (m_b0!=m_b1)||(n_b0!=n_b1)) 
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_2 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b2)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_2 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if ((2*n_a!=m_b0+m_b1)||(2*n_a!=n_b2+n_b3))
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_2 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
                                                  ...
                                                  AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_2 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if ((m_b2!=m_b3)||(n_b2!=n_b3)|| (m_b0!=m_b1)||(n_b0!=n_b1)) 
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_2 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b2)
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_2 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if ((2*n_a!=m_b0+m_b1)||(2*n_a!=n_b2+n_b3))
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_2 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
                                                ...
                                                AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_3 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b0)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if (2*n_a!=n_b0+n_b1)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_3 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
   /* prepare data */
  ...
  switch(global_sc->braess_sarazin_matrix)
  {
    case 0: /* original matrix (with alpha = 1) */
      AMG_dmatmul_SADDLE_2_TYPE_3(x_,A,B,y_);
      return(AMG_OK);
    break;
    case 1: /* idendity */
      k = 2*n_a;
                                                  ...
                                                  AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (m_b0!=m_b1)
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_3 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b0)
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if (2*n_a!=n_b0+n_b1)
     {
        AMG_Print("ERROR: dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_3 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
  ...
  switch(global_sc->braess_sarazin_matrix)
  {
    case 0: /* original matrix (with alpha = 1.0) */
      AMG_dmatminus_SADDLE_2_TYPE_3(x_,A,B,y_);
      return(AMG_OK);
      break;
    case 1: /* idendity */
      k = 2*n_a;
                                                  ...
                                                  AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
  ...
  {
    case 0: /* original matrix (with alpha = 1) */
      AMG_A_dmatmul_SADDLE_2_TYPE_3(x_,A,B,y_);
      return(AMG_OK);
      break;
    case 1: /* idendity */
      k = 2*n_a;
                                                    ...
                                                    AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatminus BRAESS_SARAZIN_SADDLE_2_TYPE_3 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
  ...
  {
    case 0: /* original matrix (with alpha = 1) */
      AMG_A_dmatminus_SADDLE_2_TYPE_3(x_,A,B,y_);
      break;
    case 1: /* idendity */
      k = 2*n_a;
      for (i=0; i<k; i++)
...
int AMG_dmatmul_BRAESS_SARAZIN_SADDLE_2_TYPE_4 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_4 - vector lengths mismatched !!\n");
        exit(4711);
     }
     if ((m_b2!=m_b3)||(n_b2!=n_b3)|| (m_b0!=m_b1)||(n_b0!=n_b1)) 
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_4 - B matrix sizes mismatched !!\n");
        exit(4711);
     }
     if (n_x!=2*n_a+m_b2)
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_4 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
     if ((2*n_a!=m_b0+m_b1)||(2*n_a!=n_b2+n_b3))
     {
        AMG_Print("ERROR: dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_4 - matrix sizes mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
  ...
  {
    case 0: /* original matrix */
      AMG_dmatmul_SADDLE_2_TYPE_4(x_,A,B,y_);
      return(AMG_OK);
    break;
    case 1: /* idendity */
      k = 2*n_a;
...
int AMG_dmatminus_BRAESS_SARAZIN_SADDLE_2_TYPE_4 (AMG_VECTOR *x_, AMG_MATRIX *A, AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  {
  case 0: /* original matrix */
    AMG_dmatminus_SADDLE_2_TYPE_4(x_,A,B,y_);
    return(AMG_OK);
    break;
  case 1: /* idendity */
    k = 2*n_a;
                                   ...
                                   AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  if (global_sc->verbose>1)
  {
     if (n_x!=n_y)
     {
        AMG_Print("ERROR: A_dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_4 - vector lengths mismatched !!\n");
        exit(4711);
     }
     
     if (n_x!=2*n_a)
     {
        AMG_Print("ERROR: A_dmatmul BRAESS_SARAZIN_SADDLE_2_TYPE_4 - vector and matrix lengths mismatched !!\n");
        exit(4711);
     }
  }
  /* prepare data */
  ...
  {
  case 0: /* original matrix */
    AMG_A_dmatmul_SADDLE_2_TYPE_4(x_,A,B,y_);
    return(AMG_OK);
    break;
  case 1: /* idendity */
    k = 2*n_a;
                                   ...
                                   AMG_MATRIX **B, AMG_VECTOR *y_)
{
  ...
  {
  case 0: /* original matrix */
    AMG_A_dmatminus_SADDLE_2_TYPE_4(x_,A,B,y_);
    break;
  case 1: /* idendity */
    k = 2*n_a;
    for (i=0; i<k; i++)
