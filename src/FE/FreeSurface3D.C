  ...
  for(i=0;i<N_SurfaceJoints;i++)
  {
    ...
    switch(RefElement)
    {
      case BFUnitHexahedron:
       ...
       // ((THexaTrilinear *)F_K)->SetApproximationOrder(l);
       // ((THexaTrilinear *)F_K)->SetQuadFormula(QF3);
    ...
    cout << " Crossed Switch"<<endl;
    ((THexaAffin *)F_K)->GetOrigValues(N_UsedElements,
                             BaseFuncts,
                             N_Points3, xi, eta, zeta,
                             QF3, SecondDer);
    cout << " Crossed Switch"<<endl;  
    ((THexaAffin *)F_K)->GetOrigFromRef(N_Points3, xi, eta, zeta,
                                         X, Y, Z, absdetjk);
    ...
    for(j=0;j<N_Points2;j++)
    {
      ...
      {
        case BFUnitHexahedron:
          ((THexaAffin *)F_K)->GetTangentVectors(
