    ...
    switch(NSEType)
       {
        ...
        case 4:
			if(!(TDatabase::ParamDB->REMOVE_REDUNDANT_DIRICHLET)){
				  AssembleMatrix_NSE4();
			}
			else
			{
				AssembleMatrix_NSE4_withoutremovingRedundantDirichlet();
			}
...
// THIVIN  
// Same as AssembleMatrix_NSE4(), without the removal of redundant 1's of dirichlet boundaries in the off diagonal BLocks of the Matrix
void TSeqParDirectSolver::AssembleMatrix_NSE4_withoutremovingRedundantDirichlet()
{
  int N_Active;
