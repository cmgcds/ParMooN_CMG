/** ************************************************************************ 
* @brief     source file for TSystemTBE_Mode2D
...
TSystemTBE_Mode2D::TSystemTBE_Mode2D(TFESpace2D *velocity_fespace,TFEVectFunct2D *Velocity, 
                           double *sol, double *rhs, int disctype, int solver, TFEVectFunct2D *Velo_Mode):
                           TSystemTBE2D(velocity_fespace, Velocity, sol, rhs, disctype, solver)
{
  Velocity_Mode = Velo_Mode;
...
TSystemTBE_Mode2D::~TSystemTBE_Mode2D()
{
...
void TSystemTBE_Mode2D::Init(CoeffFct2D *lincoeffs, BoundCondFunct2D *BoundCond, BoundValueFunct2D *U1BoundValue,  
                        BoundValueFunct2D *U2BoundValue, TAuxParam2D *beaux, TAuxParam2D *beaux_error)
{
  ...
  // InitializeDiscreteFormsBurgers_Mode(DiscreteFormGalerkin, DiscreteFormSDFEM, DiscreteFormUpwind, DiscreteFormNLGalerkin,
